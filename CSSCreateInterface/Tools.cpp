...
bool Tools::GetBonePosEx(uintptr_t boneBase, int boneID,Vector& bonePos, Vec2& screen)
{
...
bool Tools::GetBonePosEx_1(uintptr_t boneBase, int boneID, Vector& bonePos, Vec2& screen)
{
	bonePos.x = *(float*)((boneBase + 0x30 * boneID + 0x0C));
	bonePos.y = *(float*)((boneBase + 0x30 * boneID + 0x1C));
	bonePos.z = *(float*)((boneBase + 0x30 * boneID + 0x2C)) + 10;
