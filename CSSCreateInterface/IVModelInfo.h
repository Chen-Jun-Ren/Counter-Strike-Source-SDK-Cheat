...
public:
	...
	void GetModelMaterials(void*,const model_t* model, int count, IMaterial** ppMaterials)
	{
		typedef void* (__thiscall* OriginalFn)(void*,const model_t*, int, IMaterial**);
		getvfunc<OriginalFn>(this, 16)(this, model, count, ppMaterials);
	}
	...
	int GetStudioModel(void*, int a2)
	{
		typedef int(__thiscall* OriginalFn)(void*, int);
		return getvfunc<OriginalFn>(this, 28)(this, a2);
	}
