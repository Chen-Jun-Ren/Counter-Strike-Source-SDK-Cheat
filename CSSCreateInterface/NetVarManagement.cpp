...
CNetVarManagement::CNetVarManagement()
{
	...
	this->DT_BaseCombatCharacter.m_hActiveWeapon = GetNetVarOffset("DT_BaseCombatCharacter", "m_hActiveWeapon", clientClass);
	this->DT_TEFireBullets.m_iWeaponID = GetNetVarOffset("DT_TEFireBullets", "m_iWeaponID", clientClass);
	this->DT_CSPlayer.m_angEyeAngles = GetNetVarOffset("DT_CSPlayer", "m_angEyeAngles", clientClass);
}
