...
public:
	...
	virtual bool RenderBrushModelSurface(/*C_BaseEntity*/void* pBaseEntity, IBrushSurface* pBrushSurface) = 0;
};
...
public:
	...
	virtual void DrawBrushModel(/*C_BaseEntity*/void* baseentity, model_t* model, const Vector& origin, const QAngle& angles, bool sort) = 0;
